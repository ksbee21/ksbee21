...
# Canvas 만들고자 하는 Game 은?
   ...
   그나마, Chart 등에서 SVG 에서 Canvas 로 점차 기술적인 전환이 이뤄지고 있지만, 아직도 많은 시스템에서는 활용하고 있지 않은것도 사실입니다.     

   그렇지만 점차 Web 에서 이미지 처리, 간단한 게임등을 개발하고자 하는 필요성이 발생하고 있고, Chart 3D Rendering 이 필요한 곳에서는 
